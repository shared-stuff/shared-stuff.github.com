...
g;this.FriendEditController=b;this.FriendViewController=d;this.ShareStuffController=e}).call(this);(function(){var b,d,g,e,h,c;c=utils.log;e=utils.focus;h=function(a){return!utils.isBlank(a.title)};g={friends:"Friends","public":"Public"};b=function(a,b,c){a.stuffList=[];a.isAddStuffFormHidden=!0;a.circles=g;a.sortAttribute=sessionStorage.getItem("my-stuff-sortAttribute")||"-modified";a.sortAttributeNames={"-modified":"Newest",title:"Title","owner.name":"Friend"};a.sharingDirections=Stuff.sharingDirectionValues;c.load(function(b){a.profile=b;return a.$digest()});b.list(function(b){a.stuffList=b;
a.isAddStuffFormHidden=0<a.stuffList.length;a.status="LOADED";return a.$digest()});a.showAddForm=function(){a.isAddStuffFormHidden=!1;return e("title")};a.closeForm=function(){return a.isAddStuffFormHidden=!0};a.sortBy=function(b){sessionStorage.setItem("my-stuff-sortAttribute",b);return a.sortAttribute=b};a.stuff=new Stuff({visibility:sessionStorage.getItem("new-stuff-visibility")||null});a.addStuff=function(){return h(a.stuff)?(sessionStorage.setItem("new-stuff-visibility",a.stuff.visibility),a.stuffList.push(new Stuff(a.stuff)),
b.save(a.stuffList,function(){}),a.stuff=new Stuff({visibility:a.stuff.visibility}),a.isAddStuffFormHidden=!0,e("showAddStuffFormButton")):a.showValidationErrors=!0};return e("showAddStuffFormButton")};b.$inject=["$scope","stuffDAO","profileDAO"];d=function(a,b,e,d,l){var f;a.stuff=new Stuff;a.circles=g;a.sharingDirections=Stuff.sharingDirectionValues;e.load(function(b){a.profile=b;return a.$digest()});b.getItem(d.id,function(b){c(b);a.stuff=new Stuff(b);c(a.stuff);return a.$digest()});f=function(){return a.$apply(function(){return l.path("/mystuff")})};
